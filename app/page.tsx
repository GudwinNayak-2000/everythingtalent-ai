...
export default function Page() {
  return (
    <ThemeProvider attribute="class" forcedTheme={undefined} disableTransitionOnChange defaultTheme="dark" enableSystem>
     <div>
     <Header/>
      ...
      <div className="relative z-10 overflow-x-hidden h-full w-full bg-gradient-to-br from-purple-50 via-pink-50
   ...
   dark:[mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_60%,transparent_100%)]">
      ...
      <div className="relative overflow-x-hidden h-full w-full bg-gradient-to-br from-purple-50 via-pink-50 to-white dark:from-black
      ...
      <div className="relative h-full w-full bg-gradient-to-br from-purple-50 via-pink-50 to-white dark:from-black
       dark:via-slate-900 dark:to-slate-950 py-8 sm:py-16 md:py-28 px-4 sm:px-6 lg:px-8">
        <OurJourney/>
      </div>
      <div className="relative overflow-x-hidden h-full w-full bg-gradient-to-br from-purple-50 via-pink-50 to-white dark:from-black
